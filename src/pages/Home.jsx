...
import HightlightsText from "../components/cors/Homepage/HighlightsText";
    ...
    <div>
      <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 text-white">
        ...
        <div className="text-center text-4xl font-semibold">
          ...
          <HightlightsText text={"Coding Skills"} />
        </div>
          ...
          <CodeBlocks
            ...
            heading={
              <div className="text-4xl font-semibold">
                Unlock your
                <HightlightsText text={"coding potential"} /> with our online
                courses.
              </div>
            }
            subheading={
          ...
          <CodeBlocks
            ...
            heading={
              <div className="w-[100%] text-4xl font-semibold lg:w-[50%]">
                Start
                <HightlightsText text={"coding in seconds"} />
              </div>
            }
            subheading={
      ...
      <div className="text-richblack-200 bg-pure-greys-25">
        <div className="homepage_bg h-[310px] ">
          <div className="w-11/12 max-w-maxContent flex flex-col items-center gap-5 mx-auto">
            ...
            <div className="flex flex-row gap-7 text-white">
              ...
              <CTAButton className="" active={false} linkto={"/signup"}>
                <div>Learn More</div>
              </CTAButton>
            </div>
          </div>
        ...
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 ">
          ...
          <div className="mb-10 mt-[-100px] flex flex-col justify-between gap-7 lg:mt-20 lg:flex-row lg:gap-0">
            <div className="text-4xl font-semibold lg:w-[45%] ">
              ...
              <HightlightsText text={"job that is in demand."} />
            </div>
